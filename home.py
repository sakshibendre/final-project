...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b1=Button(bg_img,image=self.photoimg8,command=self.train_pannels,cursor="hand2")
        b1.place(x=200,y=380,width=220,height=220)

        b1_1=Button(bg_img,text="Train Data",command=self.train_pannels,cursor="hand2", font=("times new roman",25,"bold"),bg="white",fg="red")
        ...
        b1_1=Button(bg_img,text="Photos",cursor="hand2",command=self.open_img, font=("times new roman",25,"bold"),bg="white",fg="red")
    ...
    def open_img(self):
        path = r'C:\final project\final project\SOURCE\data'
        os.startfile(path)
