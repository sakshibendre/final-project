...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\final project\final project\SOURCE\Images_GUI\bg2.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\final project\final project\SOURCE\Images_GUI\f_det.jpg")
    ...
    def mark_attendance(self,i,r,n):
        with open(r"C:\final project\final project\SOURCE\attendance.csv.txt","r+",newline="\n") as f:
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence > 77:
                    cv2.putText(img,f"Roll:{i}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
                    cv2.putText(img,f"Name:{n}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
                    cv2.putText(img,f"Department:{r}",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
        ...
        faceCascade=cv2.CascadeClassifier(r"C:\\final project\\final project\\SOURCE\\haarcascade_frontalface_default.xml")
        clf=cv2.face.LBPHFaceRecognizer_create()
        clf.read(r"C:\final project\clf.xml")
