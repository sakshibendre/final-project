...
class Train:
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\final project\final project\SOURCE\Images_GUI\t_bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\final project\final project\SOURCE\Images_GUI\t_btn1.png")
    ...
    def train_classifier(self):
        data_dir=(r"C:\final project\final project\SOURCE\data")
